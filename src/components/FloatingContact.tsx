...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="space-y-2">
              <a
                href="mailto:sarthak.acoustic@gmail.com"
              ...
              <a
                href="https://www.linkedin.com/in/sarthak-dalabehera/"
                target="_blank"
              ...
              <a
                href="https://github.com/TypicalDefender"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors"
              >
      ...
      <motion.button
        className="bg-primary hover:bg-blue-700 text-white p-4 rounded-full shadow-lg"
